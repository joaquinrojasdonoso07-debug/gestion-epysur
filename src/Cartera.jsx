...
// Listado Oficial de Regiones y Comunas de Chile para el Formulario
const regionesChile = [
  {
    regiones: "Región de Arica y Parinacota",
  ...
  {
    regiones: "Región del Libertador Gral. Bernardo O'Higgins",
    comunas: ["Rancagua", "Codegua", "Coinco", "Coltauco", "Doñihue", "Graneros", "Las Cabras", "Machalí", "Malloa", "Mostazal", "Olivar", "Peumo", "Pichidegua", "Quinta de Tilcoco", "Rengo", "Requínoa", "San Vicente", "Pichilemu", "La Estrella", "Litueche", "Navidad", "Alhué", "Paredones", "San Fernando", "Chépica", "Chimbarongo", "Lolol", "Nancagua", "Palmilla", "Peralillo", "Placilla", "Pumanque", "Santa Cruz"]
  },
  {
  ...
  {
    regiones: "Región Aisén del Gral. Carlos Ibáñez del Campo",
...
export default function Cartera() {
  ...
  // Lista de comunas disponibles según la región seleccionada en el formulario
  ...
  // Escucha cambios en la región para actualizar dinámicamente las comunas en el formulario
  useEffect(() => {
    if (formData.region) {
      // Intenta encontrar coincidencia exacta o aproximada para que no falle con datos antiguos
          ...
          <form onSubmit={save} style={modalContent}>
            ...
            <div style={{display:'flex', flexDirection:'column', gap:'12px'}}>
              ...
              <div>
                ...
                {/* Fallback visual si el dato viejo no coincide con la lista oficial */}
                {formData.region && !regionesChile.some(r => r.regiones === formData.region) && (
                  <span style={{fontSize:'0.7rem', color:'#ef4444'}}>Valor actual no estandarizado: "{formData.region}" (Selecciona uno nuevo para corregir)</span>
                )}
              </div>

              {/* SELECT DINÁMICO DE COMUNAS */}
              <div>
